...
class Transaction_History:
    current_time_date =""
    transaction_mode=""
    def __init__(self,tr_mode,amount):
    ...
    def Record_tr_details(self):
        ...
        file.write(f"Date Time: {self.current_time_date}   {self.transction_mode}: {self.amount}" )
    ...
    def CheckingAccount_Functions(self):
        ...
        if option != "":
            ...
            if option == "1":
                ...
                tr = Transaction_History("Money deposited",1000)
